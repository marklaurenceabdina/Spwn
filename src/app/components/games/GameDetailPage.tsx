    ...
    <div className="flex flex-col h-full overflow-y-auto" style={{ background: "var(--spwn-bg)" }}>
      ...
      <div className="px-4 pt-4 pb-8 flex-1">
        ...
        {activeTab === "overview" && (
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="text-sm leading-relaxed" style={{ color: "var(--spwn-muted)" }}>{game.longDescription || game.description}</p>
            </div>
            <div>
        ...
        {activeTab === "specs" && (
          <div className="flex flex-col gap-4">
            {[
              { label: "Minimum (Mobile)", specs: game.minSpecs, badgeBg: "rgba(239,68,68,0.15)", badgeColor: "#ef4444" },
              { label: "Recommended (Mobile)", specs: game.recSpecs, badgeBg: "rgba(0,136,221,0.15)", badgeColor: "var(--spwn-accent)" },
              ...
              <div key={label}>
                ...
                <div className="rounded-xl overflow-hidden" style={{ background: "var(--spwn-card)", border: "1px solid var(--spwn-border)" }}>
                  <div className="px-4">
                    ...
                    <SpecRow icon={Cpu} label="Chipset" value={specs.cpu} />
