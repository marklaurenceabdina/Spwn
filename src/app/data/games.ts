...
const LOW: GameSpec = { os: "Android 10+ / iOS 13+", cpu: "MediaTek Helio G85 / Snapdragon 662", ram: "2 GB", gpu: "", storage: "10 GB storage" };
const LOW_R: GameSpec = { os: "Android 11+ / iOS 14+", cpu: "MediaTek Helio G95 / Snapdragon 732G", ram: "3 GB", gpu: "", storage: "10 GB storage" };
const MID: GameSpec = { os: "Android 11+ / iOS 14+", cpu: "MediaTek Dimensity 700 / Snapdragon 765G", ram: "3 GB", gpu: "", storage: "10 GB storage" };
const MID_R: GameSpec = { os: "Android 12+ / iOS 15+", cpu: "MediaTek Dimensity 800 / Snapdragon 870", ram: "4 GB", gpu: "", storage: "10 GB storage" };
const HIGH: GameSpec = { os: "Android 12+ / iOS 15+", cpu: "MediaTek Dimensity 1000 / Snapdragon 888", ram: "4 GB", gpu: "", storage: "10 GB storage" };
const HIGH_R: GameSpec = { os: "Android 13+ / iOS 16+", cpu: "MediaTek Dimensity 1200 / Snapdragon 8 Gen 1", ram: "6 GB", gpu: "", storage: "10 GB storage" };
const ULTRA: GameSpec = { os: "Android 13+ / iOS 16+", cpu: "Flagship MediaTek Dimensity / Snapdragon 8 Gen 2", ram: "8 GB", gpu: "", storage: "10 GB storage" };
const ULTRA_R: GameSpec = { os: "Android 14+ / iOS 17+", cpu: "Latest flagship MediaTek / Snapdragon", ram: "12 GB", gpu: "", storage: "10 GB storage" };
